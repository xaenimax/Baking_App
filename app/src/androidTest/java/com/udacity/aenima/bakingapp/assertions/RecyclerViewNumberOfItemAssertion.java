package com.udacity.aenima.bakingapp.assertions;
...
public class RecyclerViewNumberOfItemAssertion implements ViewAssertion {
    private final int mExpectedNumberOfItems;

    public RecyclerViewNumberOfItemAssertion(int expectedNumberOfItems) {
